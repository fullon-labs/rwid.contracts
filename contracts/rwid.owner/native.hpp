...
namespace eosiosystem {
   ...
   /**
    * The flon core `native` contract that governs authorization and contracts' abi.
    */
   class [[eosio::contract("flon.system")]] native : public eosio::contract {
      public:
         ...
         /**
          * These actions map one-on-one with the ones defined in core layer of flon, that's where their implementation
          * actually is done.
          ...
          * This is useful because when doing authorization checks, the flon based blockchain starts with the
