...
#define TBL struct [[eosio::table, eosio::contract("realme.auth")]]
#define NTBL(name) struct [[eosio::table(name), eosio::contract("realme.auth")]]
...
NTBL("global") global_t {
    ...
    EOSLIB_SERIALIZE( global_t, (amax_dao_contract)(realme_owner_contract)(auth_type))
};
